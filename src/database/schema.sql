...
VALUES
    (1, '2025-04-05', '2025-05-06', 1, 950, 'under-paid'),
    (1, '2025-05-05', '2025-06-06', 1, 950, 'under-paid'),
    (2, '2025-05-02', '2025-06-10', 1, 1000, 'over-paid'),
    (3, '2025-06-10', '2025-07-10', 1, 875, 'under-paid'),
    (4, '2025-07-11', '2025-08-11', 1, 1100, 'over-paid'),
    (5, '2025-09-08', '2025-10-08', 1, 900, 'under-paid');
